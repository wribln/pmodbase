# This is the place to hold global constants:
  ...
  FEATURE_ID_DC1_CODES = 47
  FEATURE_ID_DCC_CODES = 48
  FEATURE_ID_SERVICE_CODES = 49
  FEATURE_ID_FUNCTION_CODES = 50
  FEATURE_ID_PRODUCT_CODES = 51
  FEATURE_ID_LOCATION_CODES = 52
  FEATURE_ID_S_CODE_SEARCH = 53
  FEATURE_ID_S_DOCUMENT_LOG = 54
  FEATURE_ID_NW_LINES = 55
  FEATURE_ID_NW_STATIONS = 56
  FEATURE_ID_NW_STOPS = 57
  FEATURE_ID_HASHTAGS = 58
  FEATURE_ID_A_DOCUMENT_LOG = 59
  FEATURE_ID_A_CODE_SEARCH = 60
  FEATURE_ID_A1_CODE = 61
  FEATURE_ID_A2_CODE = 62
  FEATURE_ID_A3_CODE = 63
  FEATURE_ID_A4_CODE = 64
  FEATURE_ID_A5_CODE = 65
  FEATURE_ID_A6_CODE = 66
  FEATURE_ID_A7_CODE = 67
  FEATURE_ID_A8_CODE = 68
  FEATURE_ID_PCP_SUBJECTS = 69
