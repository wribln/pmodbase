...
class DsrStatusRecordTest1 < ActiveSupport::TestCase
  ...
  test 'determine late prep status' do
    ...
    d.plnd_prep_start = Date.today - 1
    assert_equal 1, d.determine_late_prep
    d.plnd_prep_start += 7
    assert_equal 5, d.determine_late_prep
    d.plnd_prep_start += 7
    assert_equal 2, d.determine_late_prep
    d.actl_prep_start = d.plnd_prep_start
    assert_equal 4, d.determine_late_prep
    d.actl_prep_start += 1
    assert_equal 3, d.determine_late_prep
  end
  ...
  test 'determine late submission status' do
    ...
    d.plnd_submission_1 = Date.today - 1
  ...
  test 'determine late completion status' do
    ...
    d.plnd_completion = Date.today - 1
