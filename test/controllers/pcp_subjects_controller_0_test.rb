require 'test_helper'
class PcpSubjectsController0Test < ActionDispatch::IntegrationTest
  ...
  test 'check class attributes' do
    ...
    validate_feature_class_attributes FEATURE_ID_MY_PCP_SUBJECTS, ApplicationController::FEATURE_ACCESS_INDEX, ApplicationController::FEATURE_CONTROL_CUGRP
  end
  ...
  test 'should get release document' do
    get pcp_release_doc_path( id: @pcp_subject, step_no: 0 )
  ...
  test 'cannot get release document for current step' do
    get pcp_release_doc_path( id: @pcp_subject, step_no: 1 )
