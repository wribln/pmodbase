...
module OrlSubjectAccess
  extend ActiveSupport::Concern

  # Make sure that the given account has modify access for ORL Subjects
  # in the given group (when used inside OrlCategory) or for this ORL
  # Subject (when used inside OrlSubject).
  ...
  def given_account_has_access( account_id, group_id )
    ...
    errors.add( account_id, I18n.t( "#{ self.class.table_name }.msg.no_access" )) \
      unless a.permission_to_access( FEATURE_ID_ORL_SUBJECTS, :to_update, g_id )
  end
