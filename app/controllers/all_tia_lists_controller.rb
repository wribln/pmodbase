...
class AllTiaListsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @tia_list.save
        format.html { redirect_to all_tia_list_url( @tia_list ), notice: t( 'all_tia_lists.msg.new_ok' )}
      else
  ...
  def update
    respond_to do |format|
      if @tia_list.update( tia_list_params )
        format.html { redirect_to all_tia_list_url( @tia_list ), notice: t( 'all_tia_lists.msg.edit_ok' )}
      else
  ...
  def destroy
    @tia_list.destroy
    respond_to do |format|
      format.html { redirect_to all_tia_lists_url, notice: t( 'all_tia_lists.msg.delete_ok' )}
    end
  end
