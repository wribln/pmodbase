...
puts
puts '>>> Loading Siemens Phases - as per PM@Siemens Guide Verseion 6.0.2, released 04.10.2016'
...
SiemensPhase.create( code: '%PM080', label_p: 'Project Handover',         label_m: 'Project Initiated' )
