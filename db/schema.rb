...
ActiveRecord::Schema.define(version: 20170127112428) do
  ...
  create_table "a1_codes", force: :cascade do |t|
    ...
    t.index ["code"], name: "index_a1_codes_on_code"
  end
  ...
  create_table "a2_codes", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["code"], name: "index_a2_codes_on_code"
  end
  ...
  create_table "a3_codes", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["code"], name: "index_a3_codes_on_code"
  end
  ...
  create_table "a4_codes", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["code"], name: "index_a4_codes_on_code"
  end
  ...
  create_table "a5_codes", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["code"], name: "index_a5_codes_on_code"
  end
  ...
  create_table "a6_codes", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["code"], name: "index_a6_codes_on_code"
  end
  ...
  create_table "a7_codes", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["code"], name: "index_a7_codes_on_code"
  end
  ...
  create_table "a8_codes", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["code"], name: "index_a8_codes_on_code"
  end
  ...
  create_table "a_document_logs", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["account_id"], name: "index_a_document_logs_on_account_id"
    t.index ["id"], name: "index_a_document_logs_on_id"
  end
  ...
  create_table "abbreviations", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["sort_code"], name: "index_abbreviations_on_sort_code"
  end
  ...
  create_table "addresses", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["label"], name: "index_addresses_on_label"
  end
  ...
  create_table "cfr_file_types", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["label"], name: "index_cfr_file_types_on_label"
  end
  ...
  create_table "cfr_locations", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["cfr_location_type_id"], name: "index_cfr_locations_on_cfr_location_type_id"
    t.index ["cfr_record_id"], name: "index_cfr_locations_on_cfr_record_id"
  end
  ...
  create_table "cfr_records", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["cfr_file_type_id"], name: "index_cfr_records_on_cfr_file_type_id"
    t.index ["group_id"], name: "index_cfr_records_on_group_id"
    t.index ["id"], name: "cfr_default_order"
    t.index ["main_location_id"], name: "index_cfr_records_on_main_location_id"
  end
  ...
  create_table "cfr_relations", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["cfr_relationship_id"], name: "index_cfr_relations_on_cfr_relationship_id"
    t.index ["dst_record_id"], name: "index_cfr_relations_on_dst_record_id"
    t.index ["src_record_id"], name: "index_cfr_relations_on_src_record_id"
  end
  ...
  create_table "cfr_relationships", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["reverse_rs_id"], name: "index_cfr_relationships_on_reverse_rs_id"
  end
  ...
  create_table "country_names", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["code"], name: "index_country_names_on_code"
  end
  ...
  create_table "csr_status_records", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["correspondence_date"], name: "index_csr_status_records_on_correspondence_date"
    t.index ["correspondence_type"], name: "index_csr_status_records_on_correspondence_type"
  end
  ...
  create_table "db_change_requests", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["requesting_account_id"], name: "index_db_change_requests_on_requesting_account_id"
    t.index ["responsible_account_id"], name: "index_db_change_requests_on_responsible_account_id"
  end
  ...
  create_table "dcc_codes", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["code"], name: "index_dcc_codes_on_code"
  end
  ...
  create_table "dsr_doc_groups", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["group_id"], name: "index_dsr_doc_groups_on_group_id"
  end
  ...
  create_table "dsr_progress_rates", id: false, force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["document_status"], name: "index_dsr_progress_rates_on_document_status", unique: true
  end
  ...
  create_table "dsr_status_records", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["dsr_current_submission_id"], name: "index_dsr_status_records_on_dsr_current_submission_id"
    t.index ["dsr_doc_group_id"], name: "index_dsr_status_records_on_dsr_doc_group_id"
    t.index ["prep_activity_id"], name: "index_dsr_status_records_on_prep_activity_id"
    t.index ["receiver_group_id"], name: "index_dsr_status_records_on_receiver_group_id"
    t.index ["sender_group_b_id"], name: "index_dsr_status_records_on_sender_group_b_id"
    t.index ["sender_group_id"], name: "index_dsr_status_records_on_sender_group_id"
    t.index ["subm_activity_id"], name: "index_dsr_status_records_on_subm_activity_id"
    t.index ["submission_group_b_id"], name: "index_dsr_status_records_on_submission_group_b_id"
    t.index ["submission_group_id"], name: "index_dsr_status_records_on_submission_group_id"
  end
  ...
  create_table "dsr_submissions", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["dsr_status_record_id", "submission_no"], name: "dsr_submissions_key2", unique: true
    t.index ["dsr_status_record_id"], name: "index_dsr_submissions_on_dsr_status_record_id"
  end
  ...
  create_table "function_codes", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["code"], name: "index_function_codes_on_code"
  end
  ...
  create_table "glossary_items", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["cfr_record_id"], name: "index_glossary_items_on_cfr_record_id"
    t.index ["code"], name: "index_glossary_items_on_code"
    t.index ["term"], name: "index_glossary_items_on_term"
  end
  ...
  create_table "group_categories", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["seqno", "label"], name: "group_categories_key2"
  end
  ...
  create_table "groups", force: :cascade do |t|
    ...
    t.index ["sub_group_of_id"], name: "index_groups_on_sub_group_of_id"
  end
  ...
  create_table "hashtags", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["feature_id", "code"], name: "index_hashtags_on_feature_id_and_code", unique: true
    t.index ["feature_id"], name: "index_hashtags_on_feature_id"
  end
  ...
  create_table "holidays", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["country_name_id"], name: "index_holidays_on_country_name_id"
    t.index ["date_from"], name: "index_holidays_on_date_from"
    t.index ["region_name_id"], name: "index_holidays_on_region_name_id"
    t.index ["year_period"], name: "index_holidays_on_year_period"
  end
  ...
  create_table "isr_agreements", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["based_on_id"], name: "index_isr_agreements_on_based_on_id"
    t.index ["cfr_record_id"], name: "index_isr_agreements_on_cfr_record_id"
    t.index ["isr_interface_id", "ia_no", "rev_no"], name: "isa_default_order", unique: true
    t.index ["isr_interface_id"], name: "index_isr_agreements_on_isr_interface_id"
    t.index ["l_deputy_id"], name: "index_isr_agreements_on_l_deputy_id"
    t.index ["l_group_id"], name: "index_isr_agreements_on_l_group_id"
    t.index ["l_owner_id"], name: "index_isr_agreements_on_l_owner_id"
    t.index ["p_deputy_id"], name: "index_isr_agreements_on_p_deputy_id"
    t.index ["p_group_id"], name: "index_isr_agreements_on_p_group_id"
    t.index ["p_owner_id"], name: "index_isr_agreements_on_p_owner_id"
    t.index ["res_steps_id"], name: "index_isr_agreements_on_res_steps_id"
    t.index ["val_steps_id"], name: "index_isr_agreements_on_val_steps_id"
  end
  ...
  create_table "isr_interfaces", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["cfr_record_id"], name: "index_isr_interfaces_on_cfr_record_id"
    t.index ["l_group_id", "p_group_id"], name: "isr_default_order"
    t.index ["l_group_id"], name: "index_isr_interfaces_on_l_group_id"
    t.index ["p_group_id"], name: "index_isr_interfaces_on_p_group_id"
  end
  ...
  create_table "location_codes", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["code"], name: "index_location_codes_on_code"
    t.index ["part_of_id"], name: "index_location_codes_on_part_of_id"
  end
  ...
  create_table "network_lines", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["location_code_id"], name: "index_network_lines_on_location_code_id"
  end
  ...
  create_table "network_stops", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["location_code_id"], name: "index_network_stops_on_location_code_id"
    t.index ["network_line_id", "stop_no"], name: "index_network_stops_on_network_line_id_and_stop_no"
    t.index ["network_line_id"], name: "index_network_stops_on_network_line_id"
    t.index ["network_station_id"], name: "index_network_stops_on_network_station_id"
  end
  ...
  create_table "pcp_categories", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["c_deputy_id"], name: "index_pcp_categories_on_c_deputy_id"
    t.index ["c_group_id"], name: "index_pcp_categories_on_c_group_id"
    t.index ["c_owner_id"], name: "index_pcp_categories_on_c_owner_id"
    t.index ["p_deputy_id"], name: "index_pcp_categories_on_p_deputy_id"
    t.index ["p_group_id"], name: "index_pcp_categories_on_p_group_id"
    t.index ["p_owner_id"], name: "index_pcp_categories_on_p_owner_id"
  end
  ...
  create_table "pcp_comments", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["pcp_item_id", "pcp_step_id"], name: "pcp_comments_index"
    t.index ["pcp_item_id"], name: "index_pcp_comments_on_pcp_item_id"
    t.index ["pcp_step_id"], name: "index_pcp_comments_on_pcp_step_id"
  end
  ...
  create_table "pcp_items", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["pcp_step_id"], name: "index_pcp_items_on_pcp_step_id"
    t.index ["pcp_subject_id", "id"], name: "pcp_items_index"
    t.index ["pcp_subject_id"], name: "index_pcp_items_on_pcp_subject_id"
  end
  ...
  create_table "pcp_members", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["account_id"], name: "index_pcp_members_on_account_id"
    t.index ["pcp_subject_id", "account_id", "pcp_group"], name: "pcp_members_index", unique: true
    t.index ["pcp_subject_id", "pcp_group"], name: "pcp_group_members"
    t.index ["pcp_subject_id"], name: "index_pcp_members_on_pcp_subject_id"
  end
  ...
  create_table "pcp_steps", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["pcp_subject_id", "report_version"], name: "pcp_steps_report_versions", unique: true
    t.index ["pcp_subject_id", "step_no"], name: "pcp_steps_index", unique: true
    t.index ["pcp_subject_id"], name: "index_pcp_steps_on_pcp_subject_id"
  end
  ...
  create_table "pcp_subjects", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["archived", "pcp_category_id", "id"], name: "active_pcp_subjects"
    t.index ["c_deputy_id"], name: "index_pcp_subjects_on_c_deputy_id"
    t.index ["c_group_id"], name: "index_pcp_subjects_on_c_group_id"
    t.index ["c_owner_id"], name: "index_pcp_subjects_on_c_owner_id"
    t.index ["cfr_record_id"], name: "index_pcp_subjects_on_cfr_record_id"
    t.index ["p_deputy_id"], name: "index_pcp_subjects_on_p_deputy_id"
    t.index ["p_group_id"], name: "index_pcp_subjects_on_p_group_id"
    t.index ["p_owner_id"], name: "index_pcp_subjects_on_p_owner_id"
    t.index ["pcp_category_id"], name: "index_pcp_subjects_on_pcp_category_id"
    t.index ["s_owner_id"], name: "index_pcp_subjects_on_s_owner_id"
  end
  ...
  create_table "people", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["involved"], name: "index_people_on_involved"
  end
  ...
  create_table "permission4_flows", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["account_id"], name: "index_permission4_flows_on_account_id"
    t.index ["feature_id", "workflow_id", "account_id"], name: "rfc_index", unique: true
    t.index ["feature_id"], name: "index_permission4_flows_on_feature_id"
  end
  ...
  create_table "permission4_groups", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["account_id", "feature_id", "group_id"], name: "afg_index", unique: true
    t.index ["account_id"], name: "index_permission4_groups_on_account_id"
    t.index ["feature_id"], name: "index_permission4_groups_on_feature_id"
    t.index ["group_id"], name: "index_permission4_groups_on_group_id"
  end
  ...
  create_table "phase_codes", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["code"], name: "phase_codes_std_order"
    t.index ["siemens_phase_id"], name: "index_phase_codes_on_siemens_phase_id"
  end
  ...
  create_table "product_codes", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["code"], name: "index_product_codes_on_code"
  end
  ...
  create_table "region_names", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["country_name_id", "code"], name: "cr_index", unique: true
    t.index ["country_name_id"], name: "index_region_names_on_country_name_id"
  end
  ...
  create_table "rfc_documents", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["account_id"], name: "index_rfc_documents_on_account_id"
    t.index ["rfc_status_record_id", "version"], name: "main_key", unique: true
    t.index ["rfc_status_record_id"], name: "index_rfc_documents_on_rfc_status_record_id"
  end
  ...
  create_table "s_document_logs", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["account_id"], name: "index_s_document_logs_on_account_id"
    t.index ["group_id"], name: "index_s_document_logs_on_group_id"
    t.index ["id"], name: "index_s_document_logs_on_id"
  end
  ...
  create_table "service_codes", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["code"], name: "index_service_codes_on_code"
  end
  ...
  create_table "sir_entries", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["orig_group_id"], name: "index_sir_entries_on_orig_group_id"
    t.index ["resp_group_id"], name: "index_sir_entries_on_resp_group_id"
    t.index ["sir_item_id", "created_at"], name: "sir_entries_default_order"
    t.index ["sir_item_id", "created_at"], name: "sir_entries_reverse_order"
    t.index ["sir_item_id"], name: "index_sir_entries_on_sir_item_id"
  end
  ...
  create_table "sir_items", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["cfr_record_id"], name: "index_sir_items_on_cfr_record_id"
    t.index ["group_id"], name: "index_sir_items_on_group_id"
    t.index ["phase_code_id"], name: "index_sir_items_on_phase_code_id"
    t.index ["sir_log_id"], name: "index_sir_items_on_sir_log_id"
  end
  ...
  create_table "sir_logs", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["deputy_account_id"], name: "index_sir_logs_on_deputy_account_id"
    t.index ["owner_account_id"], name: "index_sir_logs_on_owner_account_id"
  end
  ...
  create_table "sir_members", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["account_id"], name: "index_sir_members_on_account_id"
    t.index ["sir_log_id"], name: "index_sir_members_on_sir_log_id"
  end
  ...
  create_table "standards_bodies", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["code"], name: "index_standards_bodies_on_code"
  end
  ...
  create_table "submission_groups", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["code"], name: "index_submission_groups_on_code"
  end
  ...
  create_table "tia_item_deltas", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["tia_item_id", "created_at"], name: "index_tia_item_deltas_on_tia_item_id_and_created_at"
    t.index ["tia_item_id"], name: "index_tia_item_deltas_on_tia_item_id"
  end
  ...
  create_table "tia_items", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["account_id"], name: "index_tia_items_on_account_id"
    t.index ["tia_list_id", "seqno"], name: "tia_list_items_index", unique: true
    t.index ["tia_list_id"], name: "index_tia_items_on_tia_list_id"
  end
  ...
  create_table "tia_lists", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["deputy_account_id"], name: "index_tia_lists_on_deputy_account_id"
    t.index ["owner_account_id"], name: "index_tia_lists_on_owner_account_id"
  end
  ...
  create_table "tia_members", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["account_id"], name: "index_tia_members_on_account_id"
    t.index ["tia_list_id"], name: "index_tia_members_on_tia_list_id"
  end
  ...
  create_table "unit_names", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["code"], name: "index_unit_names_on_code"
  end
  ...
  create_table "web_links", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["seqno", "label"], name: "web_links_key2"
  end
